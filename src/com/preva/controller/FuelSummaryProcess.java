...
/**
 * Servlet implementation class FuelSummaryProcess
 */
public class FuelSummaryProcess extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public FuelSummaryProcess() {
        super();
		...
		List<DeviceList> devicelist=devicelistdao.getDeviceList();
			         if(devicelist!=null){
			        	 ...
			        	 session.setAttribute("devicelists", devicelist);
			        		 RequestDispatcher rd=request.getRequestDispatcher("FuelSummaryReport.jsp");
